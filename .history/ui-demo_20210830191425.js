...
function MyController() {
    ...
    c.languages = ['English', 'Italy', 'France','Vietnamese', 'Japanese', 'Laos'];

    c.testData = ['Corn', 'Onions', 'Kale', 'Test','Corn', 'Onions', 'Kale', 'Test','Corn', 'Onions', 'Kale', 'Test','Corn', 'Onions', 'Kale', 'Test'];
    // c.searchTerm = '';
